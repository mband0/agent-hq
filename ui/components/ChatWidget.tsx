    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom,0px))] md:bottom-6 right-4 md:right-6 w-14 h-14 rounded-full bg-amber-500 hover:bg-amber-400 shadow-lg shadow-amber-500/25 flex items-center justify-center transition-all duration-200 z-30 hover:scale-105 active:scale-95"
