...
3. Read the agent-hq-interaction skill — it tells you exactly how to check in, post outcomes, and escalate
...
- Use the agent-hq-interaction skill for all callbacks, outcomes, and tracking
